...
var Controladmodulos = require("../controladores/rt-modulos.controlador.js");
...
api.post("/crear-modulos",Controladmodulos.creaModulos);
//Creamos la ruta para el ingreso de usuario y utilizamos el método POST
api.post("/modulos",Controladmodulos.veModulos);
//Creamos la ruta para la actualización del usuario y utilizamos el método PUT
api.put("/actualizar-modulos/:id", md_aut.autenticacion, Controladmodulos.actualizaModulos);
//Creamos la ruta para borrar usuario y utilizamos el método DELETE
api.delete("/borrar-modulos/:id", md_aut.autenticacion, Controladmodulos.borraModulos)
